...
class AutoEncoder:
    ...
    def build_train_model(self, input_shape, encoded1_shape, encoded2_shape, decoded1_shape, decoded2_shape):
        ...
        train = pd.read_csv("preprocess/rbm_train.csv", index_col=0)
        ...
        test = pd.read_csv("preprocess/rbm_test.csv", index_col=0)
        ntest = np.array(test)
        ...
        log_train = pd.read_csv("preprocess/log_train.csv", index_col=0)
        coded_train = []
        ...
        train_coded.to_csv("feat/autoencoded_data.csv")
