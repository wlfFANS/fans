...
class DataProcessing:
    def __init__(self, split, feature_split):
        ...
        # print(train.tail())
        self.test = pd.read_csv("preprocess/test_data.csv", index_col=0)
        # print(test.tail())
        self.test_stock = pd.read_csv("preprocess/test_stock.csv", index_col=0)
        # self.auto_train = pd.read_csv("feat/autoencoded_corrected_data.csv", index_col=0)
        self.auto_train = pd.read_csv("feat/autoencoded_data.csv", index_col=0)
    ...
    def make_train_data(self):
        ...
        train_data.to_csv("feat/autoencoded_train_data.csv")
    ...
    def make_test_data(self):
        ...
        test_data.to_csv("feat/autoencoded_test_data.csv")
